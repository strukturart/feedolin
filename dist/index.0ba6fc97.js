...
var $3e4edb8379ebf8a3$var$rss_fetcher = function rss_fetcher1(param_url, param_limit, param_channel, param_category, param_type) {
    ...
    var loadEnd = function loadEnd(e) {
        ...
        if ($3e4edb8379ebf8a3$var$k == $3e4edb8379ebf8a3$var$feed_download_list.length - 1) {
            ...
            console.log($3e4edb8379ebf8a3$var$feed_download_list);
        }
        if ($3e4edb8379ebf8a3$var$k < $3e4edb8379ebf8a3$var$feed_download_list.length - 1) {
            document.getElementById("intro-message").innerText = "loading data";
            //error log
            if (xhttp.status != 200) $3e4edb8379ebf8a3$var$feed_download_list[$3e4edb8379ebf8a3$var$k].error = "error";
            $3e4edb8379ebf8a3$var$k++;
            $3e4edb8379ebf8a3$var$rss_fetcher($3e4edb8379ebf8a3$var$feed_download_list[$3e4edb8379ebf8a3$var$k].url, $3e4edb8379ebf8a3$var$feed_download_list[$3e4edb8379ebf8a3$var$k].amount, $3e4edb8379ebf8a3$var$feed_download_list[$3e4edb8379ebf8a3$var$k].title, $3e4edb8379ebf8a3$var$feed_download_list[$3e4edb8379ebf8a3$var$k].channel, $3e4edb8379ebf8a3$var$feed_download_list[$3e4edb8379ebf8a3$var$k].type);
        }
    };
...
var $3e4edb8379ebf8a3$var$read_articles = function read_articles() {
    $3e4edb8379ebf8a3$var$content_arr.length;
    return false;
