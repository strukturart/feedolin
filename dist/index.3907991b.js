    ...
    xhttp.onload = function() {
        ...
        if (xhttp.readyState === xhttp.DONE && xhttp.status == 200) {
            ...
            if (el.length > 0) for(let i = 0; i < param_limit; i++){
                ...
                if (item_link !== null && item_link.includes("https://www.youtube.com") === true) item_media = "youtube";
                else item_media = "rss";
                startlistened = "";
...
let show_article = function() {
    ...
    if (document.activeElement.getAttribute("data-media") == "podcast") {
        if (document.activeElement.classList.contains("audio-playing")) _helperJs.bottom_bar("pause", "", "options");
        else _helperJs.bottom_bar("play", "", "options");
    }
    if (document.activeElement.getAttribute("data-media") == "rss") _helperJs.bottom_bar("visit", "", "options");
    if (document.activeElement.getAttribute("data-media") == "youtube") _helperJs.bottom_bar("open", "", "options");
...
function open_url() {
    ...
    if (document.activeElement.getAttribute("data-media") == "youtube") {
        document.querySelector("div#source-page iframe").setAttribute("src", document.activeElement.getAttribute("data-link"));
...
function shortpress_action(param) {
    switch(param.key){
        ...
        case "Backspace":
            ...
            if (status.window_status == "settings") break;
            if (status.window_status == "single-article") {
                show_article_list();
                break;
            }
...
},{"mustache":"f4a22","dompurify":"8sfhq","./assets/js/helper.js":"db1Xp","./assets/js/cache.js":"8tkpL","./assets/js/scan.js":"6auJa","./assets/js/settings.js":"7Gtcu","./assets/js/audio.js":"9lrwz","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"f4a22":[function(require,module,exports) {
...
},{}],"8tkpL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../app.js":"20BJq","./helper.js":"db1Xp","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}]},["8ov0T","20BJq"], "20BJq", "parcelRequire94c2")
