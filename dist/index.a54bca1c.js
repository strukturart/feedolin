...
setTimeout($987aec5199ae6065$var$startVolumeManager, 5000);
var $987aec5199ae6065$export$5f8df7563bfeaf14 = function volume_control(t) {
    //KaiOS 3.x
...
var $5535d7a9ff238efe$var$rss_fetcher = function rss_fetcher1(param_url, param_limit, param_channel, param_category, param_type) {
    ...
    var loadEnd = function loadEnd(e) {
        ...
        if ($5535d7a9ff238efe$var$k == $5535d7a9ff238efe$var$feed_download_list.length - 1) {
            ...
            console.log($5535d7a9ff238efe$var$feed_download_list);
        }
        if ($5535d7a9ff238efe$var$k < $5535d7a9ff238efe$var$feed_download_list.length - 1) {
            document.getElementById("intro-message").innerText = "loading data";
            //error log
            if (xhttp.status != 200) $5535d7a9ff238efe$var$feed_download_list[$5535d7a9ff238efe$var$k].error = "error";
            $5535d7a9ff238efe$var$k++;
            $5535d7a9ff238efe$var$rss_fetcher($5535d7a9ff238efe$var$feed_download_list[$5535d7a9ff238efe$var$k].url, $5535d7a9ff238efe$var$feed_download_list[$5535d7a9ff238efe$var$k].amount, $5535d7a9ff238efe$var$feed_download_list[$5535d7a9ff238efe$var$k].title, $5535d7a9ff238efe$var$feed_download_list[$5535d7a9ff238efe$var$k].channel, $5535d7a9ff238efe$var$feed_download_list[$5535d7a9ff238efe$var$k].type);
        }
    };
    ...
    xhttp.onload = function() {
        ...
        if (xhttp.readyState === xhttp.DONE && xhttp.status == 200) {
            ...
            var precent = 100 / p * $5535d7a9ff238efe$var$k;
...
var $5535d7a9ff238efe$var$read_articles = function read_articles() {
    $5535d7a9ff238efe$var$content_arr.length;
    return false;
...
var $5535d7a9ff238efe$var$build = function build() {
    if ($5535d7a9ff238efe$var$content_arr.lenght > 0) (0, $162001cafa2b40fd$export$b04ad9f70842c3f1)($5535d7a9ff238efe$var$content_arr, "channel", "string");
    document.getElementById("intro").style.display = "none";
...
var $5535d7a9ff238efe$var$show_feed_download_list = function show_feed_download_list() {
    ...
    var htmlStr = "<p class='item info width-100 justify-content-spacebetween'> if you want to set the number of episodes of a channel, click on the corresponding title and change the value.the entries are savedautomatically and are valid the next time the app is started.< br > The red titles could not be downloaded <br> <br></p>";
...
var $5535d7a9ff238efe$var$start_options = function start_options() {
    ...
    if (document.activeElement.getAttribute("data-function") == "volume") navigator.volumeManager.requestShow();
};
//video-player view
