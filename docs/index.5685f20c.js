        ...
        if (permission === "granted") {
            ...
            document.addEventListener("visibilitychange", function() {
                if (document.visibilityState === "visible") {
                    ...
                    notification.close();
                    $162001cafa2b40fd$export$a224d1f4f6f98541("yes", 2000);
                }
            });
        }
    });
...
function $162001cafa2b40fd$export$be816da92314cb02(url, limit, categorie, channel) {
    var sdcard = navigator.getDeviceStorages("sdcard");
    var request = sdcard[1].get("rss-reader.json");
    request.onsuccess = function() {
        ...
        reader.addEventListener("loadend", function(event) {
            ...
            request_del.onsuccess = function() {
                ...
                var requestAdd = sdcard[1].addNamed(file, "rss-reader.json");
...
var $162001cafa2b40fd$export$9a9b3b7857355d5b = function goodbye() {
    ...
    $162001cafa2b40fd$export$247be4ede8e3a24a("", "", "");
...
var $011f805697d8f593$export$f5d05897b0194561 = function save_settings() {
    ...
    (0, $162001cafa2b40fd$export$a224d1f4f6f98541)("saved, the settings will be active the next time the app is started.", 5000);
    (0, $162001cafa2b40fd$export$a224d1f4f6f98541)("saved successfully", 2000);
    return true;
};
var $011f805697d8f593$export$556c64630c31efa4 = function load_settings_from_file() {
    ...
    (0, $162001cafa2b40fd$export$a224d1f4f6f98541)("search setting file", 2000);
    ...
    file.onsuccess = function() {
        (0, $162001cafa2b40fd$export$a224d1f4f6f98541)(file.result, 2000);
        var reader = new FileReader();
        ...
        reader.onload = function() {
            ...
            (0, $162001cafa2b40fd$export$a224d1f4f6f98541)("the settings were loaded from the file, if you want to use them permanently don't forget to save.", 3000);
...
var $011f805697d8f593$export$875389d4757e8c73 = function export_settings() {
    ...
    setTimeout(function() {
        ...
        request.onsuccess = function() {
            ...
            (0, $162001cafa2b40fd$export$a224d1f4f6f98541)("settings exported, feedolin_settings.json", 5000);
        };
        request.onerror = function() {
...
$987aec5199ae6065$var$player.preload = "metadata";
var $987aec5199ae6065$var$getduration;
var $987aec5199ae6065$var$duration = "";
...
var $987aec5199ae6065$export$5f8df7563bfeaf14 = function volume_control(param) {
    if (param == "up") {
        navigator.volumeManager.requestUp();
        setTimeout(function() {
            volume_status = false;
            if ((0, $5535d7a9ff238efe$exports.status).window_status == "source-page") navigator.spatialNavigationEnabled = true;
        }, 3000);
    }
    if (param == "down") {
...
$987aec5199ae6065$var$player.addEventListener("play", function(event) {
    (0, $162001cafa2b40fd$export$247be4ede8e3a24a)("<img src='assets/icons/23EF.svg'>", $987aec5199ae6065$var$duration, "");
});
...
$987aec5199ae6065$var$player.addEventListener("playing", function(event) {
    if ($987aec5199ae6065$var$player.networkState === 2) (0, $162001cafa2b40fd$export$a224d1f4f6f98541)("loading media", 1000);
    ...
    $987aec5199ae6065$var$getduration = setInterval(function() {
        if (!$987aec5199ae6065$var$player.paused) {
            ...
            if ((0, $5535d7a9ff238efe$exports.status).window_status == "audio-player") (0, $162001cafa2b40fd$export$247be4ede8e3a24a)("<img src='assets/icons/23EF.svg'>", $987aec5199ae6065$var$toTime(time), "");
            $987aec5199ae6065$var$remember();
        }
    }, 1000);
});
...
//get read articles
var $5535d7a9ff238efe$var$read_elem = localStorage.getItem("read_elem") != null ? JSON.parse(localStorage.getItem("read_elem")) : [];
...
//xml items
var $5535d7a9ff238efe$var$rss_title = "";
var $5535d7a9ff238efe$var$item_title = "";
var $5535d7a9ff238efe$var$item_summary = "";
var $5535d7a9ff238efe$var$item_link = "";
var $5535d7a9ff238efe$var$item_date_unix = "";
var $5535d7a9ff238efe$var$item_duration = "";
var $5535d7a9ff238efe$var$item_type = "";
var $5535d7a9ff238efe$var$item_filesize = "";
var $5535d7a9ff238efe$var$item_category = "";
var $5535d7a9ff238efe$var$item_cid = "";
var $5535d7a9ff238efe$var$item_image = "";
var $5535d7a9ff238efe$var$yt_thumbnail = "";
(0, $162001cafa2b40fd$export$19d2b7c667666dbd)("lock");
setTimeout(function() {
    (0, $162001cafa2b40fd$export$19d2b7c667666dbd)("unlock");
}, 3000);
...
var $5535d7a9ff238efe$var$reload = function reload() {
    window.location.reload(true);
    localStorage.setItem("reload", "true");
};
var $5535d7a9ff238efe$var$audio_memory;
if (localStorage.getItem("audio_memory") != null) {
    var $5535d7a9ff238efe$var$d = JSON.parse(localStorage.getItem("audio_memory"));
    $5535d7a9ff238efe$var$audio_memory = $5535d7a9ff238efe$var$d;
} else $5535d7a9ff238efe$var$audio_memory = {};
if (navigator.mozApps) {
    var $5535d7a9ff238efe$var$manifest = //KaiOs store true||false
    function manifest(a) {
        ...
        else $5535d7a9ff238efe$var$load_ads();
    };
    //ads || ads free
...
//let audio_memory;
if (localStorage.getItem("audio_memory") != null) {
    var $5535d7a9ff238efe$var$d1 = JSON.parse(localStorage.getItem("audio_memory"));
    $5535d7a9ff238efe$var$audio_memory = $5535d7a9ff238efe$var$d1;
}
/////////////////////////////
////////////////////////////
//GET URL LIST/////////////
...
//////////////////////////
//////////////////////////
var $5535d7a9ff238efe$var$nocaching = Math.floor(Date.now() / 1000);
///////////
...
var $5535d7a9ff238efe$var$load_source_opml = function load_source_opml() {
    ...
    xhttp.open("GET", source_url + "?time=" + $5535d7a9ff238efe$var$nocaching, true);
    xhttp.timeout = 25000;
...
var $5535d7a9ff238efe$var$load_feeds = function load_feeds(data) {
    ...
    for(var i = 0; i < m.length; i++){
        ...
        if (nested.length > 0) for(var z = 0; z < nested.length; z++){
            ...
            //put in list
            if (result == false) $5535d7a9ff238efe$var$feed_download_list.push({
    ...
    $5535d7a9ff238efe$var$rss_fetcher($5535d7a9ff238efe$var$feed_download_list[0].url, $5535d7a9ff238efe$var$feed_download_list[0].amount, $5535d7a9ff238efe$var$feed_download_list[0].channel, $5535d7a9ff238efe$var$feed_download_list[0].channel);
    //clean source feed
...
//download content////
//////////////////////////////
var $5535d7a9ff238efe$var$rss_fetcher = function rss_fetcher1(param_url, param_limit, param_channel, param_category) {
    var transferFailed = function transferFailed() {};
    var loadEnd = function loadEnd(e) {
        //after download build html objects
        if ($5535d7a9ff238efe$var$k == $5535d7a9ff238efe$var$feed_download_list.length - 1) {
            $5535d7a9ff238efe$var$build();
        ...
        if ($5535d7a9ff238efe$var$k < $5535d7a9ff238efe$var$feed_download_list.length - 1) {
            ...
            $5535d7a9ff238efe$var$k++;
            $5535d7a9ff238efe$var$rss_fetcher($5535d7a9ff238efe$var$feed_download_list[$5535d7a9ff238efe$var$k].url, $5535d7a9ff238efe$var$feed_download_list[$5535d7a9ff238efe$var$k].amount, $5535d7a9ff238efe$var$feed_download_list[$5535d7a9ff238efe$var$k].channel, $5535d7a9ff238efe$var$feed_download_list[$5535d7a9ff238efe$var$k].channel);
        }
    };
    var xhttp = new XMLHttpRequest({
        mozSystem: true
    ...
    xhttp.onload = function() {
        ...
        if (xhttp.readyState === xhttp.DONE && xhttp.status == 200) {
            var data = xhttp.response;
            $5535d7a9ff238efe$var$item_image = "";
            $5535d7a9ff238efe$var$item_summary = "";
            $5535d7a9ff238efe$var$item_link = "";
            $5535d7a9ff238efe$var$item_title = "";
            $5535d7a9ff238efe$var$item_type = "";
            item_media = "rss";
            $5535d7a9ff238efe$var$item_duration = "";
            $5535d7a9ff238efe$var$item_filesize = "";
            listened = "false";
            play_track = "false";
            $5535d7a9ff238efe$var$item_cid = "";
            item_read = "not-read";
            item_date = "";
            startlistened = "";
            youtube_id = "";
            $5535d7a9ff238efe$var$yt_thumbnail = "";
            item_video_url = "";
            //Channel
            $5535d7a9ff238efe$var$rss_title = data.querySelector("title").textContent || param_channel;
            param_channel = $5535d7a9ff238efe$var$rss_title;
            var p = Number($5535d7a9ff238efe$var$feed_download_list.length - 1);
            precent = 100 / p * $5535d7a9ff238efe$var$k;
            document.querySelector("div#intro div#loading-progress div div").style.width = precent + "%";
            if (data.getElementsByTagName("url")[0]) $5535d7a9ff238efe$var$item_image = data.getElementsByTagName("url")[0].textContent;
            //ATOM
            el = data.querySelectorAll("entry");
            if (el.length > 0) for(var i = 0; i < param_limit; i++){
                $5535d7a9ff238efe$var$item_title = el[i].querySelector("title").innerHTML;
                $5535d7a9ff238efe$var$item_cid = (0, $162001cafa2b40fd$export$d41d9ab3de2def3d)($5535d7a9ff238efe$var$item_title);
                var elem = el[i].querySelector("summary");
                if (elem) {
                    $5535d7a9ff238efe$var$item_summary = el[i].querySelector("summary").textContent;
                    $5535d7a9ff238efe$var$item_summary = $5535d7a9ff238efe$var$item_summary.replace(/(<!\[CDATA\[)/g, "");
                    $5535d7a9ff238efe$var$item_summary = $5535d7a9ff238efe$var$item_summary.replace(/(]]>)/g, "");
                    $5535d7a9ff238efe$var$item_summary = $5535d7a9ff238efe$var$item_summary.replace(/(&lt;!\[CDATA\[)/g, "");
                    $5535d7a9ff238efe$var$item_summary = $5535d7a9ff238efe$var$item_summary.replace(/(]]&gt;)/g, "");
                } else {
                    var elem = el[i].querySelector("content");
                    if (elem) {
                        $5535d7a9ff238efe$var$item_summary = el[i].querySelector("content").textContent;
                        $5535d7a9ff238efe$var$item_summary = $5535d7a9ff238efe$var$item_summary.replace(/(<!\[CDATA\[)/g, "");
                        $5535d7a9ff238efe$var$item_summary = $5535d7a9ff238efe$var$item_summary.replace(/(]]>)/g, "");
                        $5535d7a9ff238efe$var$item_summary = $5535d7a9ff238efe$var$item_summary.replace(/(&lt;!\[CDATA\[)/g, "");
                        $5535d7a9ff238efe$var$item_summary = $5535d7a9ff238efe$var$item_summary.replace(/(]]&gt;)/g, "");
                ...
                if (el[i].getElementsByTagNameNS("*", "thumbnail").length > 0) $5535d7a9ff238efe$var$item_image = el[i].getElementsByTagNameNS("*", "thumbnail").item(0).getAttribute("url");
                if (el[i].querySelector("link") !== null) $5535d7a9ff238efe$var$item_link = el[i].querySelector("link").getAttribute("href");
                if (el[i].querySelector("enclosure") != null || el[i].querySelector("enclosure") != undefined) {
                    ...
                    if (el[i].querySelector("enclosure").getAttribute("type")) $5535d7a9ff238efe$var$item_type = el[i].querySelector("enclosure").getAttribute("type");
                    if ($5535d7a9ff238efe$var$item_type == "audio/mpeg" || $5535d7a9ff238efe$var$item_type == "audio/aac" || $5535d7a9ff238efe$var$item_type == "audio/x-mpeg" || $5535d7a9ff238efe$var$item_type == "audio/mp3" || $5535d7a9ff238efe$var$item_type == "audio/x-m4a") item_media = "podcast";
                    if ($5535d7a9ff238efe$var$item_type == "video/mp4" || $5535d7a9ff238efe$var$item_type == "application/x-mpegurl") {
                        item_media = "video";
                    ...
                    if (el[i].querySelector("enclosure").getAttribute("length") > 0) {
                        ...
                        $5535d7a9ff238efe$var$item_filesize = (0, $162001cafa2b40fd$export$a55dc7d9a051abe5)(en_length, 2);
                    }
                }
                if (item_media == "podcast") {
                    if (el[i].getElementsByTagNameNS("*", "duration").length > 0) $5535d7a9ff238efe$var$item_duration = el[i].getElementsByTagNameNS("*", "duration")[0].textContent;
                }
                //check valid date
                if (el[i].querySelector("updated") != null || el[i].querySelector("updated") != undefined) {
                    if (el[i].querySelector("updated").innerHTML == "") {
                        $5535d7a9ff238efe$var$item_date_unix = new Date().valueOf();
                        item_date = "";
                    } else {
                        item_date = new Date(el[i].querySelector("updated").innerHTML);
                        $5535d7a9ff238efe$var$item_date_unix = item_date.valueOf();
                        item_date = item_date.toDateString();
                    }
                }
                if ($5535d7a9ff238efe$var$item_link !== null && $5535d7a9ff238efe$var$item_link.includes("https://www.youtube.com") === true) {
                    item_media = "youtube";
                ...
                if (item_media == "youtube") {
                    if (el[i].getElementsByTagNameNS("*", "group").length > 0) {
                        $5535d7a9ff238efe$var$yt_thumbnail = el[i].getElementsByTagNameNS("*", "group")[0];
                        var n = $5535d7a9ff238efe$var$yt_thumbnail.getElementsByTagNameNS("*", "thumbnail")[0];
                        $5535d7a9ff238efe$var$yt_thumbnail = n.getAttribute("url");
                    }
                }
                startlistened = "";
                if ($5535d7a9ff238efe$var$audio_memory.hasOwnProperty($5535d7a9ff238efe$var$item_cid)) start_listened = "start_listened";
                $5535d7a9ff238efe$var$content_arr.push({
                    index: 0,
                    title: (0, (/*@__PURE__*/$parcel$interopDefault($2449999283207805$exports))).sanitize($5535d7a9ff238efe$var$item_title),
                    summary: (0, (/*@__PURE__*/$parcel$interopDefault($2449999283207805$exports))).sanitize($5535d7a9ff238efe$var$item_summary),
                    link: $5535d7a9ff238efe$var$item_link,
                    date: item_date,
                    dateunix: $5535d7a9ff238efe$var$item_date_unix,
                    channel: param_channel,
                    category: param_category,
                    type: $5535d7a9ff238efe$var$item_type,
                    image: $5535d7a9ff238efe$var$item_image,
                    duration: $5535d7a9ff238efe$var$toTime($5535d7a9ff238efe$var$item_duration),
                    media: item_media,
                    filesize: $5535d7a9ff238efe$var$item_filesize,
                    cid: $5535d7a9ff238efe$var$item_cid,
                    ...
                    youtube_thumbnail: $5535d7a9ff238efe$var$yt_thumbnail,
            ...
            if (el.length > 0) for(var i1 = 0; i1 < param_limit; i1++){
                if (el[i1].querySelector("title") && el[i1].querySelector("title") != undefined) {
                    $5535d7a9ff238efe$var$item_title = el[i1].querySelector("title").innerHTML;
                    $5535d7a9ff238efe$var$item_title = $5535d7a9ff238efe$var$item_title.replace("<![CDATA[", "");
                    $5535d7a9ff238efe$var$item_title = $5535d7a9ff238efe$var$item_title.replace("]]>", "");
                }
                $5535d7a9ff238efe$var$item_cid = (0, $162001cafa2b40fd$export$d41d9ab3de2def3d)($5535d7a9ff238efe$var$item_title);
                if (el[i1].querySelector("description")) {
                    $5535d7a9ff238efe$var$item_summary = el[i1].querySelector("description").textContent;
                    $5535d7a9ff238efe$var$item_summary = $5535d7a9ff238efe$var$item_summary.replace(/(<!\[CDATA\[)/g, "");
                    $5535d7a9ff238efe$var$item_summary = $5535d7a9ff238efe$var$item_summary.replace(/(]]>)/g, "");
                    $5535d7a9ff238efe$var$item_summary = $5535d7a9ff238efe$var$item_summary.replace(/(&lt;!\[CDATA\[)/g, "");
                    $5535d7a9ff238efe$var$item_summary = $5535d7a9ff238efe$var$item_summary.replace(/(]]&gt;)/g, "");
                ...
                if (el[i1].querySelector("link")) {
                    $5535d7a9ff238efe$var$item_link = el[i1].querySelector("link").textContent;
                ...
                if (el[i1].querySelector("enclosure") != null || el[i1].querySelector("enclosure") != undefined) {
                    ...
                    $5535d7a9ff238efe$var$item_link = el[i1].querySelector("enclosure").getAttribute("url");
                    if (el[i1].querySelector("enclosure").getAttribute("type")) $5535d7a9ff238efe$var$item_type = el[i1].querySelector("enclosure").getAttribute("type");
                    if ($5535d7a9ff238efe$var$item_type == "audio/mpeg" || $5535d7a9ff238efe$var$item_type == "audio/aac" || $5535d7a9ff238efe$var$item_type == "audio/x-mpeg" || $5535d7a9ff238efe$var$item_type == "audio/mp3" || $5535d7a9ff238efe$var$item_type == "audio/x-m4a") item_media = "podcast";
                    if ($5535d7a9ff238efe$var$item_type == "video/mp4" || $5535d7a9ff238efe$var$item_type == "application/x-mpegurl") {
                        item_media = "video";
                    ...
                    if (el[i1].querySelector("enclosure").getAttribute("length") > 0) {
                        ...
                        $5535d7a9ff238efe$var$item_filesize = (0, $162001cafa2b40fd$export$a55dc7d9a051abe5)(en_length1, 2);
                    }
                }
                if (item_media == "podcast") {
                    if (el[i1].getElementsByTagNameNS("*", "duration").length > 0) $5535d7a9ff238efe$var$item_duration = el[i1].getElementsByTagNameNS("*", "duration")[0].textContent;
                }
                startlistened = "";
                if ($5535d7a9ff238efe$var$audio_memory.hasOwnProperty($5535d7a9ff238efe$var$item_cid)) startlistened = "start_listened";
                $5535d7a9ff238efe$var$content_arr.push({
                    index: 0,
                    title: (0, (/*@__PURE__*/$parcel$interopDefault($2449999283207805$exports))).sanitize($5535d7a9ff238efe$var$item_title),
                    summary: (0, (/*@__PURE__*/$parcel$interopDefault($2449999283207805$exports))).sanitize($5535d7a9ff238efe$var$item_summary),
        ...
        if (xhttp.status === 301) {
            ...
            $5535d7a9ff238efe$var$rss_fetcher(xhttp.getResponseHeader("Location"), param_limit, param_channel, param_channel);
        }
...
var $5535d7a9ff238efe$var$read_articles = function read_articles() {
    ...
    $5535d7a9ff238efe$var$content_arr.forEach(function(index) {
        ...
        index.read = "not-read";
        if ($5535d7a9ff238efe$var$read_elem.length > 0) $5535d7a9ff238efe$var$read_elem.forEach(function(p) {
...
var $5535d7a9ff238efe$var$clean_localstorage = function clean_localstorage() {
    for(var i = 0; i < $5535d7a9ff238efe$var$read_elem.length; i++)if ($5535d7a9ff238efe$var$all_cid.indexOf($5535d7a9ff238efe$var$read_elem[i]) == -1) $5535d7a9ff238efe$var$read_elem.slice(i, 1);
    localStorage.setItem("read_elem", JSON.stringify($5535d7a9ff238efe$var$read_elem));
    //recently played
...
//build html
function $5535d7a9ff238efe$var$build() {
    ...
    $5535d7a9ff238efe$var$panels.push("recently-played");
...
var $5535d7a9ff238efe$var$mark_as_read = function mark_as_read(un_read) {
    if (un_read == true) {
        ...
        $5535d7a9ff238efe$var$read_elem.push($5535d7a9ff238efe$export$471f7ae5c4103ae1.active_element_id);
        localStorage.setItem("read_elem", JSON.stringify($5535d7a9ff238efe$var$read_elem));
    ...
    if (un_read == false) {
        ...
        var test = [];
        for(var i = 0; i < $5535d7a9ff238efe$var$read_elem.length; i++)if ($5535d7a9ff238efe$var$read_elem[i] != kk) test.push($5535d7a9ff238efe$var$read_elem[i]);
        localStorage.setItem("read_elem", JSON.stringify(test));
        $5535d7a9ff238efe$var$read_elem = test;
...
var $5535d7a9ff238efe$var$sort_tab = function sort_tab(type) {
    ...
    console.log($5535d7a9ff238efe$var$heroArray, $5535d7a9ff238efe$export$471f7ae5c4103ae1.current_panel);
...
function $5535d7a9ff238efe$var$nav_panels(left_right) {
    ...
    console.log($5535d7a9ff238efe$export$471f7ae5c4103ae1);
...
var $5535d7a9ff238efe$var$channel_navigation = function channel_navigation(direction) {
    var el1 = document.activeElement;
    if (direction == "down") {
        // Get the next sibling element
        var sibling = el1.nextElementSibling;
        // If the sibling matches our selector, use it
        // If not, jump to the next sibling and continue the loop
        while(sibling){
            console.log(sibling.getAttribute("data-channel") + "/" + el1.getAttribute("data-channel"));
            if (sibling.getAttribute("data-channel") != el1.getAttribute("data-channel")) {
                sibling.focus();
                var rect = document.activeElement.getBoundingClientRect();
                var elY = rect.top - document.body.getBoundingClientRect().top + rect.height / 2;
                document.activeElement.parentNode.scrollBy({
    ...
    if (direction == "up") {
        // Get the next sibling element
        var sibling = el1.previousElementSibling;
        // If the sibling matches our selector, use it
        // If not, jump to the next sibling and continue the loop
        while(sibling){
...
var $5535d7a9ff238efe$var$toTime = function toTime(seconds) {
    var n = "";
    if (seconds == "") n = "";
    else try {
        var date = new Date();
    ...
    if (document.activeElement.getAttribute("data-media") == "video") {
        ...
        $5535d7a9ff238efe$var$video_player.onplaying = function() {
            ...
            $5535d7a9ff238efe$var$video_time = setInterval(function() {
                ...
                document.getElementById("progress-bar").style.display = "block";
                document.querySelector("div#progress-bar div").style.width = percent + "%";
                if ($5535d7a9ff238efe$var$video_status == "playing") (0, $162001cafa2b40fd$export$247be4ede8e3a24a)("<img src='assets/icons/23EF.svg'>", $5535d7a9ff238efe$var$toTime(t), "");
                if ($5535d7a9ff238efe$var$video_status == "paused") (0, $162001cafa2b40fd$export$247be4ede8e3a24a)("<img src='assets/icons/23EF.svg'>", $5535d7a9ff238efe$var$toTime(t), "");
            }, 1000);
        };
        $5535d7a9ff238efe$var$video_player.onpause = function() {
            document.getElementById("message").style.top = "-1000px";
            $5535d7a9ff238efe$var$video_status = "paused";
            (0, $162001cafa2b40fd$export$247be4ede8e3a24a)("<img src='assets/icons/23EF.svg'>", $5535d7a9ff238efe$var$toTime(t), "");
        };
        return;
    }
    //youtube
    if (document.activeElement.getAttribute("data-media") == "youtube") {
        var onPlayerStateChange = function onPlayerStateChange(event) {
            if (event.data == YT.PlayerState.PLAYING) {
                ...
                (0, $162001cafa2b40fd$export$247be4ede8e3a24a)("<img src='assets/icons/23EF.svg'>", $5535d7a9ff238efe$var$toTime(t1), "");
            }
            if (event.data == YT.PlayerState.PAUSED) $5535d7a9ff238efe$var$youtube_status = "paused";
            $5535d7a9ff238efe$var$youtube_time = setInterval(function() {
                t1 = $5535d7a9ff238efe$var$youtube_player.getDuration() - $5535d7a9ff238efe$var$youtube_player.getCurrentTime();
                var percent = $5535d7a9ff238efe$var$youtube_player.getCurrentTime() / $5535d7a9ff238efe$var$youtube_player.getDuration() * 100;
                document.getElementById("progress-bar").style.display = "block";
                document.querySelector("div#progress-bar div").style.width = percent + "%";
                if ($5535d7a9ff238efe$var$youtube_status == "playing") (0, $162001cafa2b40fd$export$247be4ede8e3a24a)("<img src='assets/icons/23EF.svg'>", $5535d7a9ff238efe$var$toTime(t1), "");
                if ($5535d7a9ff238efe$var$youtube_status == "paused") (0, $162001cafa2b40fd$export$247be4ede8e3a24a)("<img src='assets/icons/23EF.svg'>", $5535d7a9ff238efe$var$toTime(t1), "");
            }, 1000);
        };
...
var $5535d7a9ff238efe$var$start_options = function start_options() {
    ...
    if (document.activeElement.getAttribute("data-function") == "reload") $5535d7a9ff238efe$var$reload();
    ...
    if (document.activeElement.getAttribute("data-function") == "audio-player") $5535d7a9ff238efe$var$open_player(true);
    if (document.activeElement.getAttribute("data-function") == "volume") {
        navigator.volumeManager.requestShow();
        $5535d7a9ff238efe$export$471f7ae5c4103ae1.volume_status = true;
...
var $5535d7a9ff238efe$var$open_player = function open_player(reopen) {
    ...
    document.getElementById("options").style.display = "none";
    if ($5535d7a9ff238efe$export$471f7ae5c4103ae1.active_audio_element_id != "") document.querySelector('[data-id="' + $5535d7a9ff238efe$export$471f7ae5c4103ae1.active_audio_element_id + '"]').focus();
...
document.querySelector("#source-local").addEventListener("change", function(event) {
    ...
    console.log($5535d7a9ff238efe$var$_this.value);
});
...
function $5535d7a9ff238efe$var$shortpress_action(param) {
    switch(param.key){
        ...
        case "ArrowDown":
            ...
            if ($5535d7a9ff238efe$export$471f7ae5c4103ae1.volume_status === true) {
                (0, $987aec5199ae6065$export$5f8df7563bfeaf14)("down");
                break;
            }
            break;
        case "ArrowUp":
            ...
            if ($5535d7a9ff238efe$export$471f7ae5c4103ae1.volume_status === true) {
                (0, $987aec5199ae6065$export$5f8df7563bfeaf14)("up");
                break;
            }
            break;
        case "*":
            $5535d7a9ff238efe$var$open_player(true);
            break;
        case "#":
            navigator.volumeManager.requestShow();
            $5535d7a9ff238efe$export$471f7ae5c4103ae1.volume_status = true;
        ...
        case "Alt":
            ...
            break;
        case "EndCall":
            (0, $162001cafa2b40fd$export$9a9b3b7857355d5b)();
            break;
        case "Backspace":
            console.log($5535d7a9ff238efe$export$471f7ae5c4103ae1.window_status);
